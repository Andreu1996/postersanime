...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer([
            // la primera linea indica en que vista quiero tener disponible el contenido de la segunda linea, si separamos por comas y ponemos otras rutas utilizaremos esta misma variable en otras vistas
