            ...
            <div class="column"> 
                ...
                <div class="total-price-elements">
                    <div class="desktop-two-columns">
                        ...
                        <div class="column">
                            <div class="total-price-element">
                                <p>{{(($cart->quantity)*($cart->price->base_price))*($cart->price->tax->multiplicator)/100}} €</p>
                            </div>
                        </div>
                    </div>
                    <div class="desktop-two-columns">
                    ...
                    <div class="desktop-two-columns">
                        ...
                        <div class="column">
                            <div class="total-price-element">
                                <input value="{{((($cart->quantity)*($cart->price->base_price))*($cart->price->tax->multiplicator)/100)+((($cart->quantity))*($cart->price->base_price))}} €" disabled>  
                            </div>
                        </div>
                    </div>
                </div>
