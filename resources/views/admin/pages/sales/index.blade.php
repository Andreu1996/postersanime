...
<table class="tablefill">
    ...
    <thead>
        <tr>
            ...
            <th class="text-center">ticked cliente</th>
    ...
    <tbody class="table-hover">
        @if(isset($sales))
            @foreach($sales as $sale_element)
                <tr>
                    <td class="text-center">{{$sale_element->id}}</td>
                    <td class="text-left">{{$sale_element->ticked_number}}</td>
                    <td class="text-left">{{$sale_element->created_at}}</td>                   
                    <td>
                        <div class="edit-remove-buttons">
                            ...
                            <div class="remove-button" data-url="{{route('sales_destroy', ['sale' => $sale_element->id])}}">
                        ...
                        <div class="sidetable-header-options">
                            ...
                            <div class="sidetable-header-element">     
                                <div class="sidetable-header-clean">
                                    <div class="sidetable-header-svg create-button" data-url="{{route('sales_create')}}">
